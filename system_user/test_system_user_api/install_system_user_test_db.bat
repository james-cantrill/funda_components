...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres  -p 5432 -f create_system_user_test_db.sql 1> install_system_user_test_db.log 2>&1

"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d system_user_test_db  -p 5432 -f install_pgcrypto.sql  1>> install_system_user_test_db.log 2>>&1
