...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d system_user_test_db  -p 5432 -f test_data_for_util_inaction_logout.sql  1>> test_util_inaction_logout.log 2>>&1 
