...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\system_user\system_user_database\table_definitions\system_user_last_active.sql 1>> install_reports_manager_test_db.log 2>>&1
...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\programs_manager\programs_manager_database\action_functions\action_enter_edit_organization_level.sql 1>> install_reports_manager_test_db.log 2>>&1 
...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\programs_manager\programs_manager_database\action_functions\action_enter_edit_programs.sql 1>> install_reports_manager_test_db.log 2>>&1 
...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\programs_manager\programs_manager_database\action_functions\action_load_program_list_vue_jstree.sql 1>> install_reports_manager_test_db.log 2>>&1 
...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\reports_manager\report_manager_database\action_functions\action_load_report_list_vue_jstree.sql 1>> install_reports_manager_test_db.log 2>>&1 

"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\reports_manager\report_manager_database\action_functions\action_load_selected_report.sql 1>> install_reports_manager_test_db.log 2>>&1 

"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\steps_reporting\report_manager\report_manager_database\utility_functions\util_is_report_viewable_to_user.sql 1>> install_reports_manager_test_db.log 2>>&1 
...
"C:\Program Files\PostgreSQL\9.6\bin\psql.exe" -h localhost -U postgres -d reports_manager_test_db  -p 5432 -f C:\funda_components\reports_manager\report_manager_database\reports_manager_test_db\install_program_manager_test_data.sql 1> install_program_manager_test_data.log 2>&1 
